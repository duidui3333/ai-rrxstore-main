    ...
    <div className="fixed right-6 bottom-6 z-50 flex flex-col gap-4">
      {NAV_ITEMS.map((item) => (
        <div key={item.label} className="group relative">
          <button
            className={cn(
              "relative flex flex-col items-center justify-center w-[56px] h-[56px] rounded-full bg-white/95 backdrop-blur-sm border border-slate-200/80 text-slate-500 shadow-[0_14px_38px_rgba(15,23,42,0.18)] hover:text-blue-600 hover:bg-blue-50/70 hover:shadow-[0_18px_48px_rgba(37,99,235,0.24)] transition-all duration-200",
              item.isSolution && "ring-1 ring-white/60"
            )}
          >
            <item.icon className="w-5 h-5 mb-0.5 group-hover:scale-110 transition-transform duration-200" strokeWidth={1.5} />
      ...
      <button
        ...
        className={cn(
          "group relative flex flex-col items-center justify-center w-[56px] h-[56px] rounded-full bg-white/95 backdrop-blur-sm border border-slate-200/80 shadow-[0_14px_38px_rgba(15,23,42,0.18)] text-slate-500 hover:text-blue-600 hover:bg-blue-50/70 hover:shadow-[0_18px_48px_rgba(37,99,235,0.24)] transition-all duration-500",
