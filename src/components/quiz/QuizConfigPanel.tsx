...
export const QuizConfigPanel: React.FC<QuizConfigPanelProps> = ({
  ...
  const [rules, setRules] = useState("1. 每位人每日最多可答题3次。\n2. 答对2道及以上即可获得高级轮盘抽奖资质。\n3. 全程开启人脸AI风控作弊安全预警拦截。");
        ...
        {activeTab === "settings" && (
          <div className="space-y-4 animate-in fade-in duration-200">
            ...
            <div className="space-y-1.5">
              <label className="text-[12.5px] font-black text-slate-500 block uppercase tracking-wider">答题活动大标题</label>
              <input 
                type="text"
                value={localTitle}
            ...
            <div className="rounded-2xl border border-[#3B82F6]/10 bg-[#3B82F6]/5 p-4 flex items-start gap-3 text-[12.5px] leading-relaxed text-blue-800">
              ...
              <div className="space-y-1">
                ...
                <p className="text-blue-950/70 font-medium">
                  该答题内置多级风控反刷，可深度审计微信环境或外部浏览器非法注入作答。一键绑定企业专属中台。
                </p>
              </div>
            </div>
          </div>
        ...
        {activeTab === "prizes" && (
          <div className="space-y-4 animate-in fade-in duration-200">
            ...
            <div className="space-y-1.5">
              ...
              />
              <p className="text-[11px] text-slate-400 leading-normal font-bold">建议设置在 15% - 40% 之间，以保证玩家答题的热度与裂变动力。</p>
            </div>
        ...
        {activeTab === "dashboard" && (
          <div className="space-y-5 animate-in fade-in duration-200 text-left">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                { title: "累计答题UV", num: "12,854", diff: "+15.2%", isUp: true },
            ...
            <div className="pt-2 flex gap-2">
              <button 
                onClick={() => alert("正在筹备并打包您的『答题流失行为漏斗』Excel精简包，包含高精度作弊轨迹审计...")}
